...
mean.rel.dye1 <- daply(core.data, "name", function (x){
  sapply(1:(hyper$l+1), function(y) mean(x[x$k==y,]$rel.dye1))
  })   
 ...
 * starting with the relative intensity value gives a better regional predictive result than the absolute intensity value
 * I compare the result with weighted mean versus unweighted mean. I found it does not make much of a difference.
