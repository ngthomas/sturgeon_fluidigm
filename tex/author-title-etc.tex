...
\newcommand{\myAuthors}{Eric C. Anderson$^{*,\dagger,\S}$, Thomas C. Ng$^\ddag,*$, Eric D. Crandall$^{\dagger,*,\flat}$, and
John Carlos Garza$^{*,\dagger}$}
...
\newcommand{\myAffiliations}{$^*$Fisheries Ecology Division, 
    ...
    $^\dagger$University of California, Santa Cruz, CA, USA.
    $^\ddag$Department of Biomolecular Engineering, University of California, Santa Cruz, CA, USA. $^\flat$Current address: Division of
    Science and Environmental Policy, California State University, Monterey Bay, Seaside, CA, USA.}
