...
\newcommand{\swfscucsc}{Fisheries Ecology Division, Southwest Fisheries Science Center, National Marine Fisheries Service {\em and} University of California, Santa Cruz, 110 McAllister Way, Santa Cruz, CA 95060, USA.}
\newcommand{\crandall}{University of California {\em and} Southwest Fisheries Science Center, National Marine Fisheries Service, 110 McAllister Way, Santa Cruz, CA 95060, USA}
\newcommand{\thomas}{Department of Biomolecular Engineering, University of California {\em and} Southwest Fisheries Science Center, National Marine Fisheries Service, 110 McAllister Way, Santa Cruz, CA 95060, USA}
...
\begin{center}
\begin{tabular}{lrrr}
\input{chip_location_counts.tex}
\hline
\end{tabular}
\end{center}
\mbox{}\\
...
\begin{center}
\begin{tabular}{lrrrr}
\input{cross_chip_shared_samples.tex}
\hline
\end{tabular}
\end{center}
\hrule
...
%%%%%%
\begin{figure*}
\includegraphics[width = 0.92\textwidth]{BB_ds_Clumped_TopLabel_k002r001.pdf}~\raisebox{0.96ex}{$K = 2$} \\
\includegraphics[width = 0.92\textwidth]{BB_ds_Clumped_NoLabel_k003r001.pdf}~\raisebox{0.96ex}{$K = 3$} \\
\includegraphics[width = 0.92\textwidth]{BB_ds_Clumped_NoLabel_k004r001.pdf}~\raisebox{0.96ex}{$K = 4$}
...
\bibliography{sturgeon-fluidigm}   % name your BibTeX data base
